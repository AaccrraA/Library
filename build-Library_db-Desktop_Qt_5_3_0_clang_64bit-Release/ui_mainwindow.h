...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_3->addLayout(horizontalLayout_15, 4, 0, 1, 2);
        ...
        gridLayout_3->addWidget(gb_taking_label, 3, 0, 1, 1);
        ...
        gridLayout_3->addWidget(gb_readers_comboBox, 1, 1, 1, 1);

        verticalSpacer_6 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_3->addItem(verticalSpacer_6, 5, 0, 1, 2);

        stackedWidget->addWidget(give_book_page);
        take_book_page = new QWidget();
        take_book_page->setObjectName(QStringLiteral("take_book_page"));
        stackedWidget->addWidget(take_book_page);
